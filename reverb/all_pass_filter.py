...
class AllPassFilter(CascadedBox):
    def __init__(self, delay, gain, fs, chunks):
        ...
        _comb_filter_component = CombFilter(
            delay=delay, gain=gain, fs=fs, chunks=chunks)

        _gain2_component.insert_input_node(
            _comb_filter_component.get_output_node())
        ...
        super().insert_components((0, _gain1_component), (1, _comb_filter_component),
                                  (2, _gain2_component), (3, _adder_component))
    ...
    def insert_input_node(self, node):
        ...
        super().insert_input_node_to_component(node, 1)
